            ...
            <Navbar expand="lg" bg="dark" variant="dark" sticky="top" className="py-3 shadow-sm" expanded={expanded} onToggle={() => setExpanded(!expanded)}>
                <Container>
                    ...
                    <div className="d-lg-none d-flex align-items-center">
                        <Link to="/cart" onClick={handleNavLinkClick} className="text-decoration-none text-dark position-relative d-inline-block me-3">
                            ...
                            <Badge bg="danger" className="position-absolute top-0 start-100 translate-middle rounded-circle"
                                style={{ minWidth: '1.3rem', height: '1.3rem', fontSize: '0.75rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                {getCartCount()}
